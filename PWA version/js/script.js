...
if (cls) {
    $("body").addClass(cls);
    if(cls.length > 0){
        $('meta[name=theme-color]').attr('content', '#161616');
    }
    else{
...
$(".theme-switcher").click(function(){
    ...
    if ($('body').hasClass('dark-theme')) {
        ...
        //setCookie('body-class', '', { secure: true, 'max-age': 86400 });
        localStorage.setItem('body-class', '');
         $('meta[name=theme-color]').attr('content', '#ffffff');
        //cookVaribles('body-class', '');
        
    } else {
        $('body').addClass('dark-theme');
        //setCookie('body-class', 'dark-theme', { secure: true, 'max-age': 86400 });
