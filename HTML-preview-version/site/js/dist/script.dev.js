...
$(document).ready(function () {
  $('#accordionFlush1').on('shown.bs.collapse', function () {
    ...
    var chosenColorClassName = $(header).data('color-class-name');
...
//         var value = $(this).val();
//         if (value == 'light') {
//             window.location.assign("../dist/settings.html");
//         }
//         else if (value == 'dark') {
//             window.location.assign("../dark/settings.html");
//         }
//         else if (value == 'bing') {
...
var cls = localStorage.getItem('body-class');
...
$(".theme-switcher").click(function () {
  ...
  if ($('body').hasClass('dark-theme')) {
    $('body').removeClass('dark-theme'); //setCookie('body-class', '', { secure: true, 'max-age': 86400 });

    localStorage.setItem('body-class', ''); //cookVaribles('body-class', '');
  } else {
    $('body').addClass('dark-theme'); //setCookie('body-class', 'dark-theme', { secure: true, 'max-age': 86400 });
    //cookVaribles('body-class', 'dark-theme');

    localStorage.setItem('body-class', 'dark-theme');
  }
});